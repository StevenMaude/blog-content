...
this, I'm going to assume it's another piece of hardware to blame.I
spent several hours running [memtest86+](http://www.memtest.org/) on the
...
completely.I'd previously written about using [DBAN to wipe
...
data](https://en.wikipedia.org/wiki/Data_remanence#Data_on_solid-state_drives).How
to use hdparm to do this is well explained
[here](https://ata.wiki.kernel.org/index.php/ATA_Secure_Erase): an easy
way is to access hdparm is via a Linux boot CD.The important things to
...
it to allow you to execute the hdparm commands successfully.For the SSD
