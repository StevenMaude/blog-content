...
date: 2016-07-02T23:35:00+00:00
author: Steven Maude
tags: ["Windows", "installation"]
slug: windows-10-installation-impressions
description: A late look at Windows 10, particularly installation improvements.
---
...
experience]({{< ref "/posts/2016/windows-7-secure-boot.md" >}}). With Windows
...
6. The issue where you need to use [the `systempropertiesperformance`
   fix]({{< ref "/posts/2014/making-aero-theme-settings-stick-in.md" >}}) to
