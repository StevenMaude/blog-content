...
date: 2013-07-17T19:32:00+00:00
lastmod: 2015-01-09T16:59:00+00:00
author: Steven Maude
tags: ["server", "Samba", "radio", "Pi", "tracklisting", "Raspberry", "iplayer", "Python", "get_iplayer"]
slug: uses-for-a-raspberry-pi-part-2
description: Running the Raspberry Pi as a file and media server, and as a PVR with get_iplayer.
aliases: ["/2013/07/uses-for-a-raspberry-pi-part-2.html"]
---

<img class="article-image" src="/images/2013/Raspberry_Pi.jpg" alt="A Raspberry Pi working hard!">

In my [last
post]({{< ref "/posts/2013/uses-for-a-raspberry-pi-part-1.md" >}}),
...
<img class="article-image" src="/images/2013/get_iplayer_crontab.png" alt="Crontab with get_iplayer scheduled.">
