...
date: 2013-09-07T11:48:00+00:00
lastmod: 2013-09-07T12:07:00+00:00
author: Steven Maude
tags: ["GitHub", "SSH", "remote", "shell", "Ubuntu"]
slug: how-to-access-github-over-ssh-on-ubuntu
description: How to use GitHub over SSH in Ubuntu, and forward SSH keys to other shell accounts.
aliases: ["/2013/09/how-to-access-github-over-ssh-on-ubuntu.html"]
---
<img class="article-image" src="/images/2013/GitHub_logo.png" alt="GitHub logo">
...
it.](https://help.github.com/articles/generating-ssh-keys)
    ...
    <div class="break-out-of-list">
      <img class="article-image" src="/images/2013/GitHub_clone.png" alt="GitHub sidebar showing the position of the clone URL display.">
    </div>
