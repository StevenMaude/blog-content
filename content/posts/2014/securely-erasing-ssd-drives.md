...
date: 2014-01-04T11:22:00+00:00
lastmod: 2014-01-12T15:13:00+00:00
author: Steven Maude
tags: ["hdparm", "ATA", "Secure", "erase"]
slug: securely-erasing-ssd-drives
description: How to securely erase drives with the ATA Secure Erase function via hdparm.
aliases: ["/2014/01/securely-erasing-ssd-drives.html"]
---
So, it turns out that [I was wrong about the motherboard being the cause
of my recent Windows hibernate
issues]({{< ref "/posts/2013/things-ive-learned-from-building-and.md" >}}).
...
drives]({{< ref "/posts/2013/dariks-boot-and-nuke-unrecognized.md" >}}).
